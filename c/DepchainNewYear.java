...
public class DepchainNewYear implements Serializable {
	/**
	 * 序列化ID
	 */
	...
	public DepchainNewYear(String[] args) {
	...
	public static void main(String[] args) throws Exception {
		DepchainNewYear test = new DepchainNewYear(args);
...
//						list2.addAll(sNode.findXpath(".//Constant[@Method='false'][@Leaf='true']"));
						...
						if(!symbolName.equals("")) {
							...
							if(list_outsource.contains(symbolName)) {
								...
								System.out.println("occ2内容："+ occ2.toString());
